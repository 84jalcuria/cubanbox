  ...
  return (
    <>
      <div className='w-full flex flex-col justify-center items-stretch'>
        ...
        <section className='h-[200px] sm:h-[400px] flex justify-center items-stretch'>
          {/*About Section*/}
          ...
          <div className='relative w-full sm:flex-grow'>
            ...
            <div className='absolute hidden sm:block bottom-10 left-[10%]  border-gray-300 border-4 rounded-3xl p-5 w-[80%] h-[30%] '>
              <h1 className='h-full text-gray-300 text-xs text-right overflow-ellipsis overflow-hidden whitespace-normal'>
                ...
                sunt quis in itaque perspiciatis harum optio fugit placeat
                tempore? Nam cupiditate neque omnis laudantium eius eligendi
                ipsam et nesciunt iste. Lorem ipsum dolor, sit amet consectetur
                adipisicing elit.
              </h1>
            </div>
            {/*Button Begin Desktop*/}
            <div className='hidden sm:block absolute bottom-[26px] sm:right-20 md:right-24 lg:right-28'>
              <ButtonBeginDesktop />
            </div>
            {/*Wod Daily*/}
            <div className='sm:hidden absolute bottom-[110px] left-4 text-center'>
              <h1 className='uppercase text-white text-3xl font-extrabold tracking-tighter leading-6'>
                wod
              </h1>
              <h1 className='uppercase text-gray-400 text-[8px] tracking-[7px] leading-4 ml-1'>
                diario
              </h1>
            </div>
            {/*Button Begin Mobile*/}
            <div className='sm:hidden absolute bottom- bottom-12 left-10'>
              <ButtonBeginMobile />
            </div>
          </div>
        </section>
